...
public class InnerFrame5 extends JPanel implements RootPaneContainer, Externalizable {
    ...
    private static ImageIcon MAXIMIZE_BUTTON_ICON = IconLoader.loadIcon( IMAGE_DIR + "maximize.gif" );
    private static ImageIcon MINIMIZE_BUTTON_ICON = IconLoader.loadIcon( IMAGE_DIR + "minimize.gif" );
    ...
    private static ImageIcon PRESS_MAXIMIZE_BUTTON_ICON = IconLoader.loadIcon( IMAGE_DIR + "pressmaximize.gif" );
    private static ImageIcon PRESS_MINIMIZE_BUTTON_ICON = IconLoader.loadIcon( IMAGE_DIR + "pressminimize.gif" );
    private static ImageIcon DEFAULT_FRAME_ICON = IconLoader.loadIcon( IMAGE_DIR + "default.gif" );
    ...
    public InnerFrame5( String title ) {
        this( title, null );
    }

    public InnerFrame5( String title, ImageIcon frameIcon ) {
        this( title, frameIcon, true, true, true, true );
    }

    public InnerFrame5( String title, ImageIcon frameIcon, boolean resizeable, boolean iconizeable,
    ...
    protected void setupCapturePanel() {
        ...
        m_rootPane.getLayeredPane().add( mouseTrap, Integer.valueOf( Integer.MIN_VALUE ) );
    ...
    protected void createTitleBar() {
        m_titlePanel = new JPanel() {
            public Dimension getPreferredSize() {
                return new Dimension( InnerFrame5.this.getWidth(), m_titleBarHeight );
            }
        };
        ...
        m_maximize.addActionListener( new ActionListener() {
            public void actionPerformed( ActionEvent e ) {
                InnerFrame5.this.setMaximized( !InnerFrame5.this.isMaximized() );
            }
        } );
        ...
        m_iconize.addActionListener( new ActionListener() {
            public void actionPerformed( ActionEvent e ) {
                InnerFrame5.this.setIconified( !InnerFrame5.this.isIconified() );
            }
        } );
    ...
    class InnerFrameTitleBarMouseAdapter extends MouseInputAdapter {
        ...
        public InnerFrameTitleBarMouseAdapter( InnerFrame5 inf ) {
            m_if = inf;
        }
