...
public class DirTree3 extends JFrame {
    ...
    public DirTree3() {
        ...
        ToolTipManager.sharedInstance().registerComponent( m_tree ); // important
        ...
        CellEditorListener cel = new CellEditorListener() {
            public void editingStopped( ChangeEvent e ) {
                if ( m_editingNode != null ) {
                    ...
                    IconData idata = new IconData( DirTree3.ICON_FOLDER, DirTree3.ICON_EXPANDEDFOLDER,
                            new FileNode( newDir ) );
        ...
        Action a2 = new AbstractAction( "Delete", new ImageIcon( "Delete16.gif" ) ) {
            public void actionPerformed( ActionEvent e ) {
                ...
                File dir = node.getFile();
                if ( dir != null && dir.isDirectory() ) {
                    if ( JOptionPane.showConfirmDialog( DirTree3.this,
                            "Do you want to delete \ndirectory \"" + dir.getName() + "\" ?", DirTree3.APP_NAME,
...
class FileNode {
    ...
    public boolean expand( DefaultMutableTreeNode parent ) {
        ...
        for ( int i = 0; i < v.size(); i++ ) {
            FileNode nd = ( FileNode )v.elementAt( i );
            IconData idata = new IconData( DirTree3.ICON_FOLDER, DirTree3.ICON_EXPANDEDFOLDER, nd );
    ...
    protected File[] listFiles() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog( null, "Error reading directory " + m_file.getAbsolutePath(),
                    DirTree3.APP_NAME, JOptionPane.WARNING_MESSAGE );
            return null;
        }
    }
}
